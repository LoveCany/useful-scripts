...
function GethtmlExt(){
    ...
    return '<tr><td><input type="text" class="ext" placeholder="extension name" value="'+ext+'"></td><td id="RemoveExt" class="RemoveButton">Remove Extension</td></tr>';
}

//获得html_Type
function GethtmlType(){
    var Type = arguments[0] ? arguments[0]: '';
    return '<tr><td><input type="text" class="Type" placeholder="MIME type" value="'+Type+'"></td><td id="RemoveType" class="RemoveButton">Remove MIME</td></tr>';
}
...
$('#SaveExt').bind("click", function(){
    ...
    $('#ExtTd tr').each(function(i){
        ...
        if(Tempext == null || Tempext == undefined || Tempext == ''){
            Prompt('The extension is empty',1000);
            success = false;
            return false;
        }
    ...
    $('#ExtTy tr').each(function(i){
        ...
        if(Tempext == null || Tempext == undefined || Tempext == ''){
            Prompt('MIME type is empty',1000);
            success = false;
            return false;
        }
        Type[i] = {"Type":Tempext};
